...
\item Two use cases:
	\begin{itemize}
		\item Services that are \alert{seldomly used}: cups, sshd
			\hbr
		\item During system boot, \alert{parallelize startup} of services and delay synchronization until first interaction using sockets
\end{itemize}
\hbr
